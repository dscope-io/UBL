...
public type ShipmentTypeCommonaggregatecomponents_21 = Any;
...
public type ContractTypeCommonaggregatecomponents_21 = Any;
...
public type DeliveryTypeCommonaggregatecomponents_21 = Any;
	...
	public type TransportEquipmentTypeCommonaggregatecomponents_21 = {
		ID : ?IDTypeCommonbasiccomponents_21;
		AirFlowPercent : ?AirFlowPercentTypeCommonbasiccomponents_21;
		AnimalFoodApprovedIndicator : ?AnimalFoodApprovedIndicatorTypeCommonbasiccomponents_21;
		Package : ?[PackageTypeCommonaggregatecomponents_21];

		QuarantineTransportEvent : ?[TransportEventTypeCommonaggregatecomponents_21];

		LoadingTransportEvent : ?[TransportEventTypeCommonaggregatecomponents_21];

		TareWeightMeasure : ?TareWeightMeasureTypeCommonbasiccomponents_21;
		HazardousGoodsTransit : ?[HazardousGoodsTransitTypeCommonaggregatecomponents_21];

		MeasurementDimension : ?[DimensionTypeCommonaggregatecomponents_21];

		Characteristics : ?CharacteristicsTypeCommonbasiccomponents_21;
		TrackingDeviceCode : ?TrackingDeviceCodeTypeCommonbasiccomponents_21;
		DispositionCode : ?DispositionCodeTypeCommonbasiccomponents_21;
		ServiceAllowanceCharge : ?[AllowanceChargeTypeCommonaggregatecomponents_21];

		OperatingParty : ?PartyTypeCommonaggregatecomponents_21;
		StorageLocation : ?LocationTypeCommonaggregatecomponents_21;
		RefrigeratedIndicator : ?RefrigeratedIndicatorTypeCommonbasiccomponents_21;
		Description : ?[DescriptionTypeCommonbasiccomponents_21];
		...
		PowerIndicator : ?PowerIndicatorTypeCommonbasiccomponents_21;
		TraceID : ?TraceIDTypeCommonbasiccomponents_21;
		LoadingProofParty : ?PartyTypeCommonaggregatecomponents_21;
		SpecialTransportRequirements : ?[SpecialTransportRequirementsTypeCommonbasiccomponents_21];

		Information : ?[InformationTypeCommonbasiccomponents_21];

		MaximumTemperature : ?TemperatureTypeCommonaggregatecomponents_21;
		UnloadingLocation : ?LocationTypeCommonaggregatecomponents_21;
		Delivery : ?DeliveryTypeCommonaggregatecomponents_21;
		AttachedTransportEquipment : ?[TransportEquipmentTypeCommonaggregatecomponents_21];

		SizeTypeCode : ?SizeTypeCodeTypeCommonbasiccomponents_21;
		ContainedInTransportEquipment : ?[TransportEquipmentTypeCommonaggregatecomponents_21];

		PositioningTransportEvent : ?[TransportEventTypeCommonaggregatecomponents_21];

		TransportEquipmentSeal : ?[TransportEquipmentSealTypeCommonaggregatecomponents_21];

		RefrigerationOnIndicator : ?RefrigerationOnIndicatorTypeCommonbasiccomponents_21;
		TransportEquipmentTypeCode : ?TransportEquipmentTypeCodeTypeCommonbasiccomponents_21;
		TransportEvent : ?[TransportEventTypeCommonaggregatecomponents_21];

		HandlingTransportEvent : ?[TransportEventTypeCommonaggregatecomponents_21];

		HumidityPercent : ?HumidityPercentTypeCommonbasiccomponents_21;
		LegalStatusIndicator : ?LegalStatusIndicatorTypeCommonbasiccomponents_21;
		GrossWeightMeasure : ?GrossWeightMeasureTypeCommonbasiccomponents_21;
		Pickup : ?PickupTypeCommonaggregatecomponents_21;
		ApplicableTransportMeans : ?TransportMeansTypeCommonaggregatecomponents_21;
		DangerousGoodsApprovedIndicator : ?DangerousGoodsApprovedIndicatorTypeCommonbasiccomponents_21;
		PackagedTransportHandlingUnit : ?[TransportHandlingUnitTypeCommonaggregatecomponents_21];

		GoodsItem : ?[GoodsItemTypeCommonaggregatecomponents_21];

		ProviderParty : ?PartyTypeCommonaggregatecomponents_21;
		PickupTransportEvent : ?[TransportEventTypeCommonaggregatecomponents_21];

		ReferencedConsignmentID : ?[ReferencedConsignmentIDTypeCommonbasiccomponents_21];

		GrossVolumeMeasure : ?GrossVolumeMeasureTypeCommonbasiccomponents_21;
		ProviderTypeCode : ?ProviderTypeCodeTypeCommonbasiccomponents_21;
		OwnerTypeCode : ?OwnerTypeCodeTypeCommonbasiccomponents_21;
		MinimumTemperature : ?TemperatureTypeCommonaggregatecomponents_21;
		LoadingLocation : ?LocationTypeCommonaggregatecomponents_21;
		FullnessIndicationCode : ?FullnessIndicationCodeTypeCommonbasiccomponents_21;
		FreightAllowanceCharge : ?[AllowanceChargeTypeCommonaggregatecomponents_21];

		ReturnabilityIndicator : ?ReturnabilityIndicatorTypeCommonbasiccomponents_21;
		DeliveryTransportEvent : ?[TransportEventTypeCommonaggregatecomponents_21];

		SupplierParty : ?SupplierPartyTypeCommonaggregatecomponents_21;
		HaulageTradingTerms : ?[TradingTermsTypeCommonaggregatecomponents_21];

		HumanFoodApprovedIndicator : ?HumanFoodApprovedIndicatorTypeCommonbasiccomponents_21;
	};
	...
	public type TransportServiceProviderSpecialTermsTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type PostEventNotificationDurationMeasureTypeCommonbasiccomponents_21 = {
		unitCodeListVersionID : ?Text;
		value : Float;
		unitCode : ?Text;
	};

	public type NotificationTypeCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type PreEventNotificationDurationMeasureTypeCommonbasiccomponents_21 = {
		unitCodeListVersionID : ?Text;
		value : Float;
		unitCode : ?Text;
	};

	public type NotificationRequirementTypeCommonaggregatecomponents_21 = {
		NotificationLocation : ?[LocationTypeCommonaggregatecomponents_21];

		PostEventNotificationDurationMeasure : ?PostEventNotificationDurationMeasureTypeCommonbasiccomponents_21;
		NotificationTypeCode : NotificationTypeCodeTypeCommonbasiccomponents_21;
		PreEventNotificationDurationMeasure : ?PreEventNotificationDurationMeasureTypeCommonbasiccomponents_21;
		NotificationPeriod : ?[PeriodTypeCommonaggregatecomponents_21];

		NotifyParty : ?[PartyTypeCommonaggregatecomponents_21];

	};

	public type ChangeConditionsTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type TransportUserSpecialTermsTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type TransportExecutionTermsTypeCommonaggregatecomponents_21 = {
		CommissionPaymentTerms : ?PaymentTermsTypeCommonaggregatecomponents_21;
		DeliveryTerms : ?[DeliveryTermsTypeCommonaggregatecomponents_21];

		TransportServiceProviderSpecialTerms : ?[TransportServiceProviderSpecialTermsTypeCommonbasiccomponents_21];

		PenaltyPaymentTerms : ?PaymentTermsTypeCommonaggregatecomponents_21;
		NotificationRequirement : ?[NotificationRequirementTypeCommonaggregatecomponents_21];

		ChangeConditions : ?[ChangeConditionsTypeCommonbasiccomponents_21];

		EnvironmentalEmission : ?[EnvironmentalEmissionTypeCommonaggregatecomponents_21];

		TransportUserSpecialTerms : ?[TransportUserSpecialTermsTypeCommonbasiccomponents_21];

		PaymentTerms : ?[PaymentTermsTypeCommonaggregatecomponents_21];

		ServiceChargePaymentTerms : ?PaymentTermsTypeCommonaggregatecomponents_21;
		BonusPaymentTerms : ?PaymentTermsTypeCommonaggregatecomponents_21;
	};
	...
	public type DocumentStatusReasonDescriptionTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};
	...
	public type TransportServiceProviderRemarksTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type TransportUserRemarksTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type DocumentStatusReasonCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type TransportExecutionPlanTypeTransportexecutionplan_21 = {
		ID : IDTypeCommonbasiccomponents_21;
		TransportContract : ?ContractTypeCommonaggregatecomponents_21;
		ServiceEndTimePeriod : ?PeriodTypeCommonaggregatecomponents_21;
		ValidityPeriod : ?[PeriodTypeCommonaggregatecomponents_21];

		TransportUserResponseRequiredPeriod : ?[PeriodTypeCommonaggregatecomponents_21];

		TransportExecutionTerms : ?TransportExecutionTermsTypeCommonaggregatecomponents_21;
		AtLocation : ?LocationTypeCommonaggregatecomponents_21;
		ReceiverParty : ?PartyTypeCommonaggregatecomponents_21;
		AdditionalTransportationService : ?[TransportationServiceTypeCommonaggregatecomponents_21];
		...
		FromLocation : ?LocationTypeCommonaggregatecomponents_21;
		ToLocation : ?LocationTypeCommonaggregatecomponents_21;
		ProfileExecutionID : ?ProfileExecutionIDTypeCommonbasiccomponents_21;
		TransportServiceProviderParty : PartyTypeCommonaggregatecomponents_21;
		DocumentStatusCode : ?DocumentStatusCodeTypeCommonbasiccomponents_21;
		TransportExecutionPlanRequestDocumentReference : ?DocumentReferenceTypeCommonaggregatecomponents_21;
		DocumentStatusReasonDescription : ?[DocumentStatusReasonDescriptionTypeCommonbasiccomponents_21];

		CustomizationID : ?CustomizationIDTypeCommonbasiccomponents_21;
		MainTransportationService : ?TransportationServiceTypeCommonaggregatecomponents_21;
		TransportServiceProviderRemarks : ?[TransportServiceProviderRemarksTypeCommonbasiccomponents_21];

		BillToParty : ?PartyTypeCommonaggregatecomponents_21;
		TransportUserRemarks : ?[TransportUserRemarksTypeCommonbasiccomponents_21];
		...
		DocumentStatusReasonCode : ?DocumentStatusReasonCodeTypeCommonbasiccomponents_21;
		TransportServiceProviderResponseRequiredPeriod : ?PeriodTypeCommonaggregatecomponents_21;
		UBLVersionID : ?UBLVersionIDTypeCommonbasiccomponents_21;
		ServiceStartTimePeriod : ?PeriodTypeCommonaggregatecomponents_21;
		UBLExtensions : ?UBLExtensionsTypeCommonextensioncomponents_21;
		TransportUserParty : PartyTypeCommonaggregatecomponents_21;
		TransportServiceDescriptionDocumentReference : ?DocumentReferenceTypeCommonaggregatecomponents_21;
		TransportExecutionPlanDocumentReference : ?DocumentReferenceTypeCommonaggregatecomponents_21;
