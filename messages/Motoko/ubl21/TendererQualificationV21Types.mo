module {
	...
	public type PreviousVersionIDTypeCommonbasiccomponents_21 = {
		schemeAgencyName : ?Text;
		schemeURI : ?Text;
		value : Text;
		schemeDataURI : ?Text;
...
public type PartyTypeCommonaggregatecomponents_21 = Any;
	...
	public type DocumentReferenceTypeCommonaggregatecomponents_21 = {
		ID : IDTypeCommonbasiccomponents_21;
		ValidityPeriod : ?PeriodTypeCommonaggregatecomponents_21;
		LanguageID : ?LanguageIDTypeCommonbasiccomponents_21;
		UUID : ?UUIDTypeCommonbasiccomponents_21;
		CopyIndicator : ?CopyIndicatorTypeCommonbasiccomponents_21;
		DocumentTypeCode : ?DocumentTypeCodeTypeCommonbasiccomponents_21;
		DocumentDescription : ?[DocumentDescriptionTypeCommonbasiccomponents_21];

		IssuerParty : ?PartyTypeCommonaggregatecomponents_21;
		DocumentStatusCode : ?DocumentStatusCodeTypeCommonbasiccomponents_21;
		...
		Attachment : ?AttachmentTypeCommonaggregatecomponents_21;
		DocumentType : ?DocumentTypeTypeCommonbasiccomponents_21;
		XPath : ?[XPathTypeCommonbasiccomponents_21];

		LocaleCode : ?LocaleCodeTypeCommonbasiccomponents_21;
		ResultOfVerification : ?ResultOfVerificationTypeCommonaggregatecomponents_21;
	};
	...
	public type CandidateStatementTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type EvidenceTypeCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type EvidenceTypeCommonaggregatecomponents_21 = {
		ID : ?IDTypeCommonbasiccomponents_21;
		Description : ?[DescriptionTypeCommonbasiccomponents_21];

		EvidenceIssuingParty : ?PartyTypeCommonaggregatecomponents_21;
		Language : ?LanguageTypeCommonaggregatecomponents_21;
		CandidateStatement : ?[CandidateStatementTypeCommonbasiccomponents_21];

		DocumentReference : ?DocumentReferenceTypeCommonaggregatecomponents_21;
		EvidenceTypeCode : ?EvidenceTypeCodeTypeCommonbasiccomponents_21;
	};
	...
	public type TendererRoleCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type AgencyIDTypeCommonbasiccomponents_21 = {
		schemeAgencyName : ?Text;
		schemeURI : ?Text;
		value : Text;
		schemeDataURI : ?Text;
	...
	public type ClassificationCategoryTypeCommonaggregatecomponents_21 = {
		Name : ?NameTypeCommonbasiccomponents_21;
		Description : ?[DescriptionTypeCommonbasiccomponents_21];

		CategorizesClassificationCategory : ?[ClassificationCategoryTypeCommonaggregatecomponents_21];

		CodeValue : ?CodeValueTypeCommonbasiccomponents_21;
	};

	public type CodeValueTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type LastRevisionDateTypeCommonbasiccomponents_21 = {
		value : XMLOffsetDateXml;
	};

	public type LastRevisionTimeTypeCommonbasiccomponents_21 = {
		value : XMLOffsetTimeXml;
	};

	public type AgencyNameTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type SchemeURITypeCommonbasiccomponents_21 = {
		schemeAgencyName : ?Text;
		schemeURI : ?Text;
		value : Text;
		schemeDataURI : ?Text;
	...
	public type ClassificationSchemeTypeCommonaggregatecomponents_21 = {
		ID : IDTypeCommonbasiccomponents_21;
		URI : ?URITypeCommonbasiccomponents_21;
		Name : ?NameTypeCommonbasiccomponents_21;
		Note : ?[NoteTypeCommonbasiccomponents_21];
		...
		LanguageID : ?LanguageIDTypeCommonbasiccomponents_21;
		UUID : ?UUIDTypeCommonbasiccomponents_21;
		AgencyID : ?AgencyIDTypeCommonbasiccomponents_21;
		ClassificationCategory : [ClassificationCategoryTypeCommonaggregatecomponents_21];
		Description : ?[DescriptionTypeCommonbasiccomponents_21];

		LastRevisionDate : ?LastRevisionDateTypeCommonbasiccomponents_21;
		LastRevisionTime : ?LastRevisionTimeTypeCommonbasiccomponents_21;
		AgencyName : ?AgencyNameTypeCommonbasiccomponents_21;
		VersionID : ?VersionIDTypeCommonbasiccomponents_21;
		SchemeURI : ?SchemeURITypeCommonbasiccomponents_21;
	};

	public type DeclarationTypeCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type EvidenceSuppliedTypeCommonaggregatecomponents_21 = {
		ID : IDTypeCommonbasiccomponents_21;
	};

	public type DeclarationTypeCommonaggregatecomponents_21 = {
		DeclarationTypeCode : ?DeclarationTypeCodeTypeCommonbasiccomponents_21;
		Name : ?[NameTypeCommonbasiccomponents_21];

		Description : ?[DescriptionTypeCommonbasiccomponents_21];

		EvidenceSupplied : ?[EvidenceSuppliedTypeCommonaggregatecomponents_21];

	};

	public type PartyCapacityAmountTypeCommonbasiccomponents_21 = {
		value : Float;
		currencyID : ?Text;
		currencyCodeListVersionID : ?Text;
	};
	...
	public type TotalTaskAmountTypeCommonbasiccomponents_21 = {
		value : Float;
		currencyID : ?Text;
		currencyCodeListVersionID : ?Text;
	};

	public type AnnualAverageAmountTypeCommonbasiccomponents_21 = {
		value : Float;
		currencyID : ?Text;
		currencyCodeListVersionID : ?Text;
	};

	public type CompletedTaskTypeCommonaggregatecomponents_21 = {
		PartyCapacityAmount : ?PartyCapacityAmountTypeCommonbasiccomponents_21;
		RecipientCustomerParty : ?CustomerPartyTypeCommonaggregatecomponents_21;
		Description : ?[DescriptionTypeCommonbasiccomponents_21];

		TotalTaskAmount : ?TotalTaskAmountTypeCommonbasiccomponents_21;
		Period : ?PeriodTypeCommonaggregatecomponents_21;
		EvidenceSupplied : ?[EvidenceSuppliedTypeCommonaggregatecomponents_21];

		AnnualAverageAmount : ?AnnualAverageAmountTypeCommonbasiccomponents_21;
	};

	public type PersonalSituationTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type BusinessClassificationEvidenceIDTypeCommonbasiccomponents_21 = {
		schemeAgencyName : ?Text;
		schemeURI : ?Text;
		value : Text;
		schemeDataURI : ?Text;
	...
	public type CapabilityTypeCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type CapabilityTypeCommonaggregatecomponents_21 = {
		ValidityPeriod : ?PeriodTypeCommonaggregatecomponents_21;
		CapabilityTypeCode : ?CapabilityTypeCodeTypeCommonbasiccomponents_21;
		Description : ?[DescriptionTypeCommonbasiccomponents_21];
	...
	public type ParticipationPercentTypeCommonbasiccomponents_21 = {
		value : Float;
		format : ?Text;
	};

	public type BusinessIdentityEvidenceIDTypeCommonbasiccomponents_21 = {
		schemeAgencyName : ?Text;
		schemeURI : ?Text;
		value : Text;
		schemeDataURI : ?Text;
	...
	public type RoleDescriptionTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type RoleCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type EconomicOperatorRoleTypeCommonaggregatecomponents_21 = {
		RoleDescription : ?[RoleDescriptionTypeCommonbasiccomponents_21];

		RoleCode : ?RoleCodeTypeCommonbasiccomponents_21;
	};

	public type OperatingYearsQuantityTypeCommonbasiccomponents_21 = {
		value : Float;
		unitCodeListAgencyID : ?Text;
		unitCodeListAgencyName : ?Text;
		unitCode : ?Text;
	...
	public type EmployeeQuantityTypeCommonbasiccomponents_21 = {
		value : Float;
		unitCodeListAgencyID : ?Text;
		unitCodeListAgencyName : ?Text;
		unitCode : ?Text;
	...
	public type QualifyingPartyTypeCommonaggregatecomponents_21 = {
		TendererRoleCode : ?TendererRoleCodeTypeCommonbasiccomponents_21;
		BusinessClassificationScheme : ?ClassificationSchemeTypeCommonaggregatecomponents_21;
		Declaration : ?[DeclarationTypeCommonaggregatecomponents_21];

		Party : ?PartyTypeCommonaggregatecomponents_21;
		CompletedTask : ?[CompletedTaskTypeCommonaggregatecomponents_21];

		PersonalSituation : ?[PersonalSituationTypeCommonbasiccomponents_21];

		BusinessClassificationEvidenceID : ?BusinessClassificationEvidenceIDTypeCommonbasiccomponents_21;
		TechnicalCapability : ?[CapabilityTypeCommonaggregatecomponents_21];

		ParticipationPercent : ?ParticipationPercentTypeCommonbasiccomponents_21;
		BusinessIdentityEvidenceID : ?BusinessIdentityEvidenceIDTypeCommonbasiccomponents_21;
		EconomicOperatorRole : ?EconomicOperatorRoleTypeCommonaggregatecomponents_21;
		OperatingYearsQuantity : ?OperatingYearsQuantityTypeCommonbasiccomponents_21;
		EmployeeQuantity : ?EmployeeQuantityTypeCommonbasiccomponents_21;
		FinancialCapability : ?[CapabilityTypeCommonaggregatecomponents_21];

	};

	public type ProcurementSubTypeCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type MinimumNumberNumericTypeCommonbasiccomponents_21 = {
		value : Float;
		format : ?Text;
	};
	...
	public type RenewalTypeCommonaggregatecomponents_21 = {
		Amount : ?AmountTypeCommonbasiccomponents_21;
		Period : ?PeriodTypeCommonaggregatecomponents_21;
	};

	public type OptionsDescriptionTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type MaximumNumberNumericTypeCommonbasiccomponents_21 = {
		value : Float;
		format : ?Text;
	};

	public type ContractExtensionTypeCommonaggregatecomponents_21 = {
		MinimumNumberNumeric : ?MinimumNumberNumericTypeCommonbasiccomponents_21;
		OptionValidityPeriod : ?PeriodTypeCommonaggregatecomponents_21;
		Renewal : ?[RenewalTypeCommonaggregatecomponents_21];

		OptionsDescription : ?[OptionsDescriptionTypeCommonbasiccomponents_21];

		MaximumNumberNumeric : ?MaximumNumberNumericTypeCommonbasiccomponents_21;
	};

	public type EstimatedOverallContractQuantityTypeCommonbasiccomponents_21 = {
		value : Float;
		unitCodeListAgencyID : ?Text;
		unitCodeListAgencyName : ?Text;
		unitCode : ?Text;
	...
	public type QualityControlCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type ProcurementTypeCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type EstimatedOverallContractAmountTypeCommonbasiccomponents_21 = {
		value : Float;
		currencyID : ?Text;
		currencyCodeListVersionID : ?Text;
	};

	public type TotalAmountTypeCommonbasiccomponents_21 = {
		value : Float;
		currencyID : ?Text;
		currencyCodeListVersionID : ?Text;
	};
	...
	public type MaximumAmountTypeCommonbasiccomponents_21 = {
		value : Float;
		currencyID : ?Text;
		currencyCodeListVersionID : ?Text;
	};

	public type AverageSubsequentContractAmountTypeCommonbasiccomponents_21 = {
		value : Float;
		currencyID : ?Text;
		currencyCodeListVersionID : ?Text;
	};

	public type MinimumAmountTypeCommonbasiccomponents_21 = {
		value : Float;
		currencyID : ?Text;
		currencyCodeListVersionID : ?Text;
	};

	public type MonetaryScopeTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type RequestedTenderTotalTypeCommonaggregatecomponents_21 = {
		ApplicableTaxCategory : ?[TaxCategoryTypeCommonaggregatecomponents_21];

		EstimatedOverallContractAmount : ?EstimatedOverallContractAmountTypeCommonbasiccomponents_21;
		TotalAmount : ?TotalAmountTypeCommonbasiccomponents_21;
		TaxIncludedIndicator : ?TaxIncludedIndicatorTypeCommonbasiccomponents_21;
		MaximumAmount : ?MaximumAmountTypeCommonbasiccomponents_21;
		AverageSubsequentContractAmount : ?AverageSubsequentContractAmountTypeCommonbasiccomponents_21;
		MinimumAmount : ?MinimumAmountTypeCommonbasiccomponents_21;
		MonetaryScope : ?[MonetaryScopeTypeCommonbasiccomponents_21];

	};

	public type RequestedDeliveryDateTypeCommonbasiccomponents_21 = {
		value : XMLOffsetDateXml;
	};

	public type RequiredFeeAmountTypeCommonbasiccomponents_21 = {
		value : Float;
		currencyID : ?Text;
		currencyCodeListVersionID : ?Text;
	};
	...
	public type EstimatedAmountTypeCommonbasiccomponents_21 = {
		value : Float;
		currencyID : ?Text;
		currencyCodeListVersionID : ?Text;
	};

	public type RequestForTenderLineTypeCommonaggregatecomponents_21 = {
		ID : ?IDTypeCommonbasiccomponents_21;
		Item : ItemTypeCommonaggregatecomponents_21;
		Note : ?[NoteTypeCommonbasiccomponents_21];

		UUID : ?UUIDTypeCommonbasiccomponents_21;
		DeliveryPeriod : ?[PeriodTypeCommonaggregatecomponents_21];

		MaximumQuantity : ?MaximumQuantityTypeCommonbasiccomponents_21;
		EstimatedAmount : ?EstimatedAmountTypeCommonbasiccomponents_21;
		Quantity : ?QuantityTypeCommonbasiccomponents_21;
		TaxIncludedIndicator : ?TaxIncludedIndicatorTypeCommonbasiccomponents_21;
		SubRequestForTenderLine : ?[RequestForTenderLineTypeCommonaggregatecomponents_21];

		MinimumQuantity : ?MinimumQuantityTypeCommonbasiccomponents_21;
		WarrantyValidityPeriod : ?PeriodTypeCommonaggregatecomponents_21;
		MaximumAmount : ?MaximumAmountTypeCommonbasiccomponents_21;
		DocumentReference : ?[DocumentReferenceTypeCommonaggregatecomponents_21];

		RequiredItemLocationQuantity : ?[ItemLocationQuantityTypeCommonaggregatecomponents_21];
...
public type PackageTypeCommonaggregatecomponents_21 = Any;
	...
	public type FeeDescriptionTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type ProcurementProjectTypeCommonaggregatecomponents_21 = {
		ID : ?IDTypeCommonbasiccomponents_21;
		ProcurementSubTypeCode : ?ProcurementSubTypeCodeTypeCommonbasiccomponents_21;
		AdditionalCommodityClassification : ?[CommodityClassificationTypeCommonaggregatecomponents_21];

		RealizedLocation : ?[LocationTypeCommonaggregatecomponents_21];
		...
		MainCommodityClassification : ?CommodityClassificationTypeCommonaggregatecomponents_21;
		ContractExtension : ?ContractExtensionTypeCommonaggregatecomponents_21;
		EstimatedOverallContractQuantity : ?EstimatedOverallContractQuantityTypeCommonbasiccomponents_21;
		QualityControlCode : ?QualityControlCodeTypeCommonbasiccomponents_21;
		ProcurementTypeCode : ?ProcurementTypeCodeTypeCommonbasiccomponents_21;
		RequestedTenderTotal : ?RequestedTenderTotalTypeCommonaggregatecomponents_21;
		RequestedDeliveryDate : ?RequestedDeliveryDateTypeCommonbasiccomponents_21;
		RequiredFeeAmount : ?RequiredFeeAmountTypeCommonbasiccomponents_21;
		RequestForTenderLine : ?[RequestForTenderLineTypeCommonaggregatecomponents_21];

		PlannedPeriod : ?PeriodTypeCommonaggregatecomponents_21;
		FeeDescription : ?[FeeDescriptionTypeCommonbasiccomponents_21];

	};

	public type GuaranteeTypeCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type AmountRateTypeCommonbasiccomponents_21 = {
		value : Float;
		format : ?Text;
	};

	public type LiabilityAmountTypeCommonbasiccomponents_21 = {
		value : Float;
		currencyID : ?Text;
		currencyCodeListVersionID : ?Text;
	};

	public type FinancialGuaranteeTypeCommonaggregatecomponents_21 = {
		GuaranteeTypeCode : GuaranteeTypeCodeTypeCommonbasiccomponents_21;
		Description : ?[DescriptionTypeCommonbasiccomponents_21];

		ConstitutionPeriod : ?PeriodTypeCommonaggregatecomponents_21;
		AmountRate : ?AmountRateTypeCommonbasiccomponents_21;
		LiabilityAmount : ?LiabilityAmountTypeCommonbasiccomponents_21;
	};

	public type VariantConstraintIndicatorTypeCommonbasiccomponents_21 = {
		value : Bool;
	};

	public type EconomicOperatorRegistryURITypeCommonbasiccomponents_21 = {
		schemeAgencyName : ?Text;
		schemeURI : ?Text;
		value : Text;
		schemeDataURI : ?Text;
	...
	public type TenderEnvelopeTypeCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type OpenTenderIDTypeCommonbasiccomponents_21 = {
		schemeAgencyName : ?Text;
		schemeURI : ?Text;
		value : Text;
		schemeDataURI : ?Text;
	...
	public type ProcurementProjectLotTypeCommonaggregatecomponents_21 = {
		ID : IDTypeCommonbasiccomponents_21;
		ProcurementProject : ?ProcurementProjectTypeCommonaggregatecomponents_21;
		TenderingTerms : ?TenderingTermsTypeCommonaggregatecomponents_21;
	};

	public type TenderRequirementTypeCommonaggregatecomponents_21 = {
		Name : NameTypeCommonbasiccomponents_21;
		Description : ?[DescriptionTypeCommonbasiccomponents_21];

		TemplateDocumentReference : ?DocumentReferenceTypeCommonaggregatecomponents_21;
	};

	public type TenderEnvelopeIDTypeCommonbasiccomponents_21 = {
		schemeAgencyName : ?Text;
		schemeURI : ?Text;
		value : Text;
		schemeDataURI : ?Text;
	...
	public type TenderPreparationTypeCommonaggregatecomponents_21 = {
		TenderEnvelopeTypeCode : ?TenderEnvelopeTypeCodeTypeCommonbasiccomponents_21;
		OpenTenderID : ?OpenTenderIDTypeCommonbasiccomponents_21;
		Description : ?[DescriptionTypeCommonbasiccomponents_21];

		ProcurementProjectLot : ?[ProcurementProjectLotTypeCommonaggregatecomponents_21];

		DocumentTenderRequirement : ?[TenderRequirementTypeCommonaggregatecomponents_21];

		TenderEnvelopeID : TenderEnvelopeIDTypeCommonbasiccomponents_21;
	};

	public type BudgetYearNumericTypeCommonbasiccomponents_21 = {
		value : Float;
		format : ?Text;
	};

	public type BudgetAccountTypeCommonaggregatecomponents_21 = {
		ID : ?IDTypeCommonbasiccomponents_21;
		BudgetYearNumeric : ?BudgetYearNumericTypeCommonbasiccomponents_21;
		RequiredClassificationScheme : ?ClassificationSchemeTypeCommonaggregatecomponents_21;
	};

	public type BudgetAccountLineTypeCommonaggregatecomponents_21 = {
		ID : ?IDTypeCommonbasiccomponents_21;
		BudgetAccount : ?[BudgetAccountTypeCommonaggregatecomponents_21];

		TotalAmount : ?TotalAmountTypeCommonbasiccomponents_21;
	};

	public type PriceRevisionFormulaDescriptionTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type MaximumAdvertisementAmountTypeCommonbasiccomponents_21 = {
		value : Float;
		currencyID : ?Text;
		currencyCodeListVersionID : ?Text;
	};

	public type AppealTermsTypeCommonaggregatecomponents_21 = {
		AppealInformationParty : ?PartyTypeCommonaggregatecomponents_21;
		Description : ?[DescriptionTypeCommonbasiccomponents_21];

		PresentationPeriod : ?PeriodTypeCommonaggregatecomponents_21;
		MediationParty : ?PartyTypeCommonaggregatecomponents_21;
		AppealReceiverParty : ?PartyTypeCommonaggregatecomponents_21;
	};

	public type WeightingAlgorithmCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type PrizeIndicatorTypeCommonbasiccomponents_21 = {
		value : Bool;
	};

	public type BindingOnBuyerIndicatorTypeCommonbasiccomponents_21 = {
		value : Bool;
	};

	public type MinimumImprovementBidTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type WeightTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type CalculationExpressionTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type AwardingCriterionTypeCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type AwardingCriterionTypeCommonaggregatecomponents_21 = {
		ID : ?IDTypeCommonbasiccomponents_21;
		MinimumImprovementBid : ?[MinimumImprovementBidTypeCommonbasiccomponents_21];

		Weight : ?[WeightTypeCommonbasiccomponents_21];

		CalculationExpression : ?[CalculationExpressionTypeCommonbasiccomponents_21];

		Description : ?[DescriptionTypeCommonbasiccomponents_21];

		MaximumQuantity : ?MaximumQuantityTypeCommonbasiccomponents_21;
		MinimumQuantity : ?MinimumQuantityTypeCommonbasiccomponents_21;
		AwardingCriterionTypeCode : ?AwardingCriterionTypeCodeTypeCommonbasiccomponents_21;
		MaximumAmount : ?MaximumAmountTypeCommonbasiccomponents_21;
		MinimumAmount : ?MinimumAmountTypeCommonbasiccomponents_21;
		SubordinateAwardingCriterion : ?[AwardingCriterionTypeCommonaggregatecomponents_21];

		CalculationExpressionCode : ?CalculationExpressionCodeTypeCommonbasiccomponents_21;
		WeightNumeric : ?WeightNumericTypeCommonbasiccomponents_21;
	};

	public type CalculationExpressionCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type WeightNumericTypeCommonbasiccomponents_21 = {
		value : Float;
		format : ?Text;
	};

	public type FollowupContractIndicatorTypeCommonbasiccomponents_21 = {
		value : Bool;
	};

	public type LowTendersDescriptionTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type TechnicalCommitteeDescriptionTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type PaymentDescriptionTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type PrizeDescriptionTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type AwardingTermsTypeCommonaggregatecomponents_21 = {
		WeightingAlgorithmCode : ?WeightingAlgorithmCodeTypeCommonbasiccomponents_21;
		Description : ?[DescriptionTypeCommonbasiccomponents_21];

		PrizeIndicator : ?PrizeIndicatorTypeCommonbasiccomponents_21;
		BindingOnBuyerIndicator : ?BindingOnBuyerIndicatorTypeCommonbasiccomponents_21;
		AwardingCriterion : ?[AwardingCriterionTypeCommonaggregatecomponents_21];

		FollowupContractIndicator : ?FollowupContractIndicatorTypeCommonbasiccomponents_21;
		TechnicalCommitteePerson : ?[PersonTypeCommonaggregatecomponents_21];

		LowTendersDescription : ?[LowTendersDescriptionTypeCommonbasiccomponents_21];

		TechnicalCommitteeDescription : ?[TechnicalCommitteeDescriptionTypeCommonbasiccomponents_21];

		PaymentDescription : ?[PaymentDescriptionTypeCommonbasiccomponents_21];

		PrizeDescription : ?[PrizeDescriptionTypeCommonbasiccomponents_21];

	};

	public type MaximumVariantQuantityTypeCommonbasiccomponents_21 = {
		value : Float;
		unitCodeListAgencyID : ?Text;
		unitCodeListAgencyName : ?Text;
		unitCode : ?Text;
	...
	public type MinimumPercentTypeCommonbasiccomponents_21 = {
		value : Float;
		format : ?Text;
	};

	public type RateTypeCommonbasiccomponents_21 = {
		value : Float;
		format : ?Text;
	};

	public type MaximumPercentTypeCommonbasiccomponents_21 = {
		value : Float;
		format : ?Text;
	};

	public type UnknownPriceIndicatorTypeCommonbasiccomponents_21 = {
		value : Bool;
	};

	public type SubcontractingConditionsCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type SubcontractTermsTypeCommonaggregatecomponents_21 = {
		Amount : ?AmountTypeCommonbasiccomponents_21;
		MinimumPercent : ?MinimumPercentTypeCommonbasiccomponents_21;
		Rate : ?RateTypeCommonbasiccomponents_21;
		Description : ?[DescriptionTypeCommonbasiccomponents_21];

		MaximumPercent : ?MaximumPercentTypeCommonbasiccomponents_21;
		UnknownPriceIndicator : ?UnknownPriceIndicatorTypeCommonbasiccomponents_21;
		SubcontractingConditionsCode : ?SubcontractingConditionsCodeTypeCommonbasiccomponents_21;
	};

	public type AwardingMethodTypeCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type PaymentFrequencyCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
...
public type TransportEquipmentTypeCommonaggregatecomponents_21 = Any;
	...
	public type AdditionalConditionsTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type FundingProgramCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type LatestSecurityClearanceDateTypeCommonbasiccomponents_21 = {
		value : XMLOffsetDateXml;
	};

	public type RequiredCurriculaIndicatorTypeCommonbasiccomponents_21 = {
		value : Bool;
	};

	public type DocumentationFeeAmountTypeCommonbasiccomponents_21 = {
		value : Float;
		currencyID : ?Text;
		currencyCodeListVersionID : ?Text;
	};

	public type ThresholdQuantityTypeCommonbasiccomponents_21 = {
		value : Float;
		unitCodeListAgencyID : ?Text;
		unitCodeListAgencyName : ?Text;
		unitCode : ?Text;
	...
	public type ExpressionTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type ExpressionCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type ThresholdAmountTypeCommonbasiccomponents_21 = {
		value : Float;
		currencyID : ?Text;
		currencyCodeListVersionID : ?Text;
	};

	public type EvaluationCriterionTypeCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type EvaluationCriterionTypeCommonaggregatecomponents_21 = {
		ThresholdQuantity : ?ThresholdQuantityTypeCommonbasiccomponents_21;
		Expression : ?[ExpressionTypeCommonbasiccomponents_21];

		Description : ?[DescriptionTypeCommonbasiccomponents_21];

		DurationPeriod : ?PeriodTypeCommonaggregatecomponents_21;
		ExpressionCode : ?ExpressionCodeTypeCommonbasiccomponents_21;
		ThresholdAmount : ?ThresholdAmountTypeCommonbasiccomponents_21;
		SuggestedEvidence : ?[EvidenceTypeCommonaggregatecomponents_21];

		EvaluationCriterionTypeCode : ?EvaluationCriterionTypeCodeTypeCommonbasiccomponents_21;
	};

	public type TendererRequirementTypeCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type LegalReferenceTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type TendererRequirementTypeCommonaggregatecomponents_21 = {
		TendererRequirementTypeCode : ?TendererRequirementTypeCodeTypeCommonbasiccomponents_21;
		Name : ?[NameTypeCommonbasiccomponents_21];

		Description : ?[DescriptionTypeCommonbasiccomponents_21];

		LegalReference : ?LegalReferenceTypeCommonbasiccomponents_21;
		SuggestedEvidence : ?[EvidenceTypeCommonaggregatecomponents_21];

	};

	public type TendererQualificationRequestTypeCommonaggregatecomponents_21 = {
		FinancialEvaluationCriterion : ?[EvaluationCriterionTypeCommonaggregatecomponents_21];

		CompanyLegalFormCode : ?CompanyLegalFormCodeTypeCommonbasiccomponents_21;
		Description : ?[DescriptionTypeCommonbasiccomponents_21];

		TechnicalEvaluationCriterion : ?[EvaluationCriterionTypeCommonaggregatecomponents_21];

		PersonalSituation : ?[PersonalSituationTypeCommonbasiccomponents_21];

		CompanyLegalForm : ?CompanyLegalFormTypeCommonbasiccomponents_21;
		SpecificTendererRequirement : ?[TendererRequirementTypeCommonaggregatecomponents_21];

		EconomicOperatorRole : ?[EconomicOperatorRoleTypeCommonaggregatecomponents_21];

		OperatingYearsQuantity : ?OperatingYearsQuantityTypeCommonbasiccomponents_21;
		EmployeeQuantity : ?EmployeeQuantityTypeCommonbasiccomponents_21;
		RequiredBusinessClassificationScheme : ?[ClassificationSchemeTypeCommonaggregatecomponents_21];

	};

	public type PriceEvaluationCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type ExecutionRequirementCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type ContractExecutionRequirementTypeCommonaggregatecomponents_21 = {
		Name : ?[NameTypeCommonbasiccomponents_21];

		Description : ?[DescriptionTypeCommonbasiccomponents_21];

		ExecutionRequirementCode : ?ExecutionRequirementCodeTypeCommonbasiccomponents_21;
	};

	public type OtherConditionsIndicatorTypeCommonbasiccomponents_21 = {
		value : Bool;
	};

	public type FundingProgramTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type AcceptedVariantsDescriptionTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type TenderingTermsTypeCommonaggregatecomponents_21 = {
		RequiredFinancialGuarantee : ?[FinancialGuaranteeTypeCommonaggregatecomponents_21];

		VariantConstraintIndicator : ?VariantConstraintIndicatorTypeCommonbasiccomponents_21;
		ContractualDocumentReference : ?[DocumentReferenceTypeCommonaggregatecomponents_21];

		EconomicOperatorRegistryURI : ?EconomicOperatorRegistryURITypeCommonbasiccomponents_21;
		TenderPreparation : ?[TenderPreparationTypeCommonaggregatecomponents_21];

		BudgetAccountLine : ?[BudgetAccountLineTypeCommonaggregatecomponents_21];

		FiscalLegislationDocumentReference : ?DocumentReferenceTypeCommonaggregatecomponents_21;
		ContractAcceptancePeriod : ?PeriodTypeCommonaggregatecomponents_21;
		PriceRevisionFormulaDescription : ?[PriceRevisionFormulaDescriptionTypeCommonbasiccomponents_21];

		MaximumAdvertisementAmount : ?MaximumAdvertisementAmountTypeCommonbasiccomponents_21;
		Note : ?[NoteTypeCommonbasiccomponents_21];

		AppealTerms : ?AppealTermsTypeCommonaggregatecomponents_21;
		AwardingTerms : ?AwardingTermsTypeCommonaggregatecomponents_21;
		DocumentProviderParty : ?PartyTypeCommonaggregatecomponents_21;
		EnvironmentalLegislationDocumentReference : ?DocumentReferenceTypeCommonaggregatecomponents_21;
		MaximumVariantQuantity : ?MaximumVariantQuantityTypeCommonbasiccomponents_21;
		Language : ?[LanguageTypeCommonaggregatecomponents_21];

		AllowedSubcontractTerms : ?[SubcontractTermsTypeCommonaggregatecomponents_21];

		AwardingMethodTypeCode : ?AwardingMethodTypeCodeTypeCommonbasiccomponents_21;
		TenderRecipientParty : ?PartyTypeCommonaggregatecomponents_21;
		PaymentFrequencyCode : ?PaymentFrequencyCodeTypeCommonbasiccomponents_21;
		PaymentTerms : ?[PaymentTermsTypeCommonaggregatecomponents_21];

		AdditionalConditions : ?[AdditionalConditionsTypeCommonbasiccomponents_21];

		FundingProgramCode : ?FundingProgramCodeTypeCommonbasiccomponents_21;
		LatestSecurityClearanceDate : ?LatestSecurityClearanceDateTypeCommonbasiccomponents_21;
		RequiredCurriculaIndicator : ?RequiredCurriculaIndicatorTypeCommonbasiccomponents_21;
		TenderEvaluationParty : ?[PartyTypeCommonaggregatecomponents_21];

		TenderValidityPeriod : ?PeriodTypeCommonaggregatecomponents_21;
		CallForTendersDocumentReference : ?DocumentReferenceTypeCommonaggregatecomponents_21;
		AdditionalInformationParty : ?PartyTypeCommonaggregatecomponents_21;
		DocumentationFeeAmount : ?DocumentationFeeAmountTypeCommonbasiccomponents_21;
		PenaltyClause : ?[ClauseTypeCommonaggregatecomponents_21];

		ReplacedNoticeDocumentReference : ?DocumentReferenceTypeCommonaggregatecomponents_21;
		TendererQualificationRequest : ?[TendererQualificationRequestTypeCommonaggregatecomponents_21];

		EmploymentLegislationDocumentReference : ?DocumentReferenceTypeCommonaggregatecomponents_21;
		WarrantyValidityPeriod : ?PeriodTypeCommonaggregatecomponents_21;
		PriceEvaluationCode : ?PriceEvaluationCodeTypeCommonbasiccomponents_21;
		ContractExecutionRequirement : ?[ContractExecutionRequirementTypeCommonaggregatecomponents_21];

		ProcurementLegislationDocumentReference : ?DocumentReferenceTypeCommonaggregatecomponents_21;
		ContractResponsibleParty : ?PartyTypeCommonaggregatecomponents_21;
		OtherConditionsIndicator : ?OtherConditionsIndicatorTypeCommonbasiccomponents_21;
		FundingProgram : ?[FundingProgramTypeCommonbasiccomponents_21];

		AcceptedVariantsDescription : ?[AcceptedVariantsDescriptionTypeCommonbasiccomponents_21];

	};

	public type TendererPartyQualificationTypeCommonaggregatecomponents_21 = {
		MainQualifyingParty : QualifyingPartyTypeCommonaggregatecomponents_21;
		InterestedProcurementProjectLot : ?[ProcurementProjectLotTypeCommonaggregatecomponents_21];

		AdditionalQualifyingParty : ?[QualifyingPartyTypeCommonaggregatecomponents_21];
	...
	public type PartyTypeTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type PartyTypeCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type ContractingPartyTypeTypeCommonaggregatecomponents_21 = {
		PartyType : ?PartyTypeTypeCommonbasiccomponents_21;
		PartyTypeCode : ?PartyTypeCodeTypeCommonbasiccomponents_21;
	};

	public type BuyerProfileURITypeCommonbasiccomponents_21 = {
		schemeAgencyName : ?Text;
		schemeURI : ?Text;
		value : Text;
		schemeDataURI : ?Text;
	...
	public type ActivityTypeCodeTypeCommonbasiccomponents_21 = {
		listURI : ?Text;
		listVersionID : ?Text;
		listName : ?Text;
		value : Text;
	...
	public type ActivityTypeTypeCommonbasiccomponents_21 = {
		value : Text;
		languageID : ?Text;
		languageLocaleID : ?Text;
	};

	public type ContractingActivityTypeCommonaggregatecomponents_21 = {
		ActivityTypeCode : ?ActivityTypeCodeTypeCommonbasiccomponents_21;
		ActivityType : ?ActivityTypeTypeCommonbasiccomponents_21;
	};

	public type ContractingPartyTypeCommonaggregatecomponents_21 = {
		Party : PartyTypeCommonaggregatecomponents_21;
		ContractingPartyType : ?[ContractingPartyTypeTypeCommonaggregatecomponents_21];

		BuyerProfileURI : ?BuyerProfileURITypeCommonbasiccomponents_21;
		ContractingActivity : ?[ContractingActivityTypeCommonaggregatecomponents_21];
	...
	public type TendererQualificationTypeTendererqualification_21 = {
		ID : IDTypeCommonbasiccomponents_21;
		Note : ?[NoteTypeCommonbasiccomponents_21];

		PreviousVersionID : ?PreviousVersionIDTypeCommonbasiccomponents_21;
		UUID : ?UUIDTypeCommonbasiccomponents_21;
		CopyIndicator : ?CopyIndicatorTypeCommonbasiccomponents_21;
		ProfileExecutionID : ?ProfileExecutionIDTypeCommonbasiccomponents_21;
		Evidence : ?[EvidenceTypeCommonaggregatecomponents_21];
		...
		TendererPartyQualification : [TendererPartyQualificationTypeCommonaggregatecomponents_21];
		UBLVersionID : ?UBLVersionIDTypeCommonbasiccomponents_21;
		ContractingParty : ?ContractingPartyTypeCommonaggregatecomponents_21;
